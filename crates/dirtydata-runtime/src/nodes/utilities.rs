...
impl MatrixMixerNode {
    pub fn new(num_in: usize, num_out: usize) -> Self {
        Self {
            inner: dirtydata_dsp_matrix::MatrixMixer::new(num_in, num_out),
        }
    }
}
...
impl SlewNode {
    pub fn new() -> Self {
        Self {
            inner: dirtydata_dsp_cv::Slew::new(),
        }
    }
}
...
impl EuclideanSequencerNode {
    pub fn new() -> Self {
        Self {
            inner: dirtydata_dsp_cv::EuclideanSequencer::new(),
        }
    }
}
...
impl FunctionGeneratorNode {
    pub fn new() -> Self {
        Self {
            inner: dirtydata_dsp_control::FunctionGenerator::new(),
        }
    }
}
impl DspNode for FunctionGeneratorNode {
    fn process(
        ...
        let out = self
            .inner
            .process(trigger, rise, fall, cycle, ctx.sample_rate);
        for o in outputs {
            *o = [out, out];
        }
    }
