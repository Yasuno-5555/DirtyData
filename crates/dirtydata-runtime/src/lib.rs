...
=======
    ...
    pub circuit_instability: Arc<dashmap::DashMap<StableId, std::collections::HashMap<usize, f32>>>,
    pub parameter_provenance: Arc<dashmap::DashMap<StableId, std::collections::HashMap<String, Vec<String>>>>,
...
<<<<<<< Updated upstream
=======
    pub node_saturation: HashMap<StableId, f32>,
    pub jit_program: Option<jit::JitProgram>,
    pub parameter_provenance: HashMap<StableId, HashMap<String, Vec<String>>>,
>>>>>>> Stashed changes
}
