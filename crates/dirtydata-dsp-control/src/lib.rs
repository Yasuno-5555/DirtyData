...
impl FunctionGenerator {
    pub fn new() -> Self { Self { state: 0.0, stage: 0 } }
    pub fn process(&mut self, trigger: f32, rise: f32, fall: f32, cycle: bool, sample_rate: f32) -> f32 {
...
impl RandomSource {
    pub fn new() -> Self { Self { prev_clock: 0.0, val: 0.0 } }
